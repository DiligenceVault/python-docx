"""Unit test suite for python_docx.image.png module."""
...
class DescribePng:
    ...
    def _PngParser_(self, request, png_parser_):
        _PngParser_ = class_mock(request, "python_docx.image.png._PngParser")
...
class Describe_PngParser:
    ...
    def _Chunks_(self, request, chunks_):
        _Chunks_ = class_mock(request, "python_docx.image.png._Chunks")
...
class Describe_Chunks:
    ...
    def _ChunkParser_(self, request, chunk_parser_):
        _ChunkParser_ = class_mock(request, "python_docx.image.png._ChunkParser")
...
class Describe_ChunkParser:
    ...
    def _ChunkFactory_(self, request, chunk_lst_):
        return function_mock(
            request, "python_docx.image.png._ChunkFactory", side_effect=chunk_lst_
        )
    ...
    def StreamReader_(self, request, stream_rdr_):
        return class_mock(
            request, "python_docx.image.png.StreamReader", return_value=stream_rdr_
        )
...
class Describe_ChunkFactory:
    ...
    def _Chunk_(self, request, chunk_):
        _Chunk_ = class_mock(request, "python_docx.image.png._Chunk")
    ...
    def _IHDRChunk_(self, request, ihdr_chunk_):
        _IHDRChunk_ = class_mock(request, "python_docx.image.png._IHDRChunk")
    ...
    def _pHYsChunk_(self, request, phys_chunk_):
        _pHYsChunk_ = class_mock(request, "python_docx.image.png._pHYsChunk")
